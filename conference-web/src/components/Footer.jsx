          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#privacy" className="text-gray-300 hover:text-orange-600 transition-colors">Privacy Policy</a></li>
                <li><a href="#terms" className="text-gray-300 hover:text-orange-600 transition-colors">Terms of Service</a></li>
                <li><a href="#help" className="text-gray-300 hover:text-orange-600 transition-colors">Help Center</a></li>
              </ul>
            </div>
          </div>
        </div>
