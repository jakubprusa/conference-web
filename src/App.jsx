      ...
      <section id="home" className="relative bg-gradient-to-br from-orange-50 to-orange-100 overflow-hidden">
        ...
        <div className="max-w-screen-xl mx-auto px-6 lg:px-12 pt-20 lg:pt-32 pb-0 relative">
          <div className="flex items-start justify-between">
            <div className="max-w-2xl pb-20 lg:pb-32 pt-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-8">
            {[
              ...
              <div key={index} className="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow flex flex-col h-full">
                <div className="h-80 md:h-96 lg:h-80 relative overflow-hidden bg-gray-100 flex-shrink-0">
                  <img
                    src={speaker.image}
                    alt={speaker.name}
